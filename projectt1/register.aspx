...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="Panel1" runat="server" BackImageUrl="~/this is.jpg" Height="600px" Width="1506px">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox ID="TextBox1" runat="server"  placeholder="First name" OnTextChanged="TextBox1_TextChanged" Width="183px"></asp:TextBox>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="TextBox3" runat="server" OnTextChanged="TextBox3_TextChanged" placeholder="Email" Width="186px"></asp:TextBox>
        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="TextBox3" ErrorMessage="enter  your valid email" ForeColor="Red" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ValidationGroup="a"></asp:RegularExpressionValidator>
        <br />
        <br />
        <asp:Label ID="Label5" runat="server" Text="Password"></asp:Label>
        &nbsp;&nbsp;&nbsp;
        <asp:TextBox ID="TextBox4" runat="server"  textmode="Password" placeholder="Password"    Width="189px"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="TextBox4" ErrorMessage="enter your Password" ForeColor="Red" ValidationGroup="a"></asp:RequiredFieldValidator>
        <br />
        <br />
...
&nbsp;<asp:Label ID="Label7" runat="server" Text="Gender"></asp:Label>
        ...
        <br />
        <br />
        <asp:Label ID="Label8" runat="server" Text="Type of lawyer"></asp:Label>
        &nbsp;&nbsp;
